...
async def main():
    ...
    # Check HyperDL availability after helper bots are started
    from .helper.ext_utils.hyperdl_checker import check_hyperdl_status
...
# Start speed monitoring system
from .helper.listeners.speed_monitor import start_speed_monitor

bot_loop.create_task(start_speed_monitor())

# Start auto-ping system to keep bot active
from .helper.ext_utils.auto_ping import start_auto_ping

bot_loop.create_task(start_auto_ping())
