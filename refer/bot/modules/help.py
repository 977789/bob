...
async def bot_help(_, message):
    buttons = ButtonMaker()
    buttons.data_button("Mirror/Leech Help", "help mirror 0")
    buttons.data_button("YT-DLP Help", "help yt 0")
    buttons.data_button("Clone Help", "help clone 0")
    buttons.data_button("Close", "help close", "footer")
    button = buttons.build_menu(2)

    await send_message(message, help_string, button)
