...
async def start(_, message):
    ...
    lang = Language()
    buttons = ButtonMaker()
    buttons.url_button(lang.START_BUTTON1, "https://t.me/+poCCGGxpoYlkNTNl")
    buttons.url_button(lang.START_BUTTON2, "https://t.me/MirrorLeechGroupz")
    ...
    ╰<b>Validity:</b> {get_readable_time(int(Config.VERIFY_TIMEOUT))}"""
            return await send_message(
                message, msg, reply_markup, photo="assets/BHARTIYEE LEECH.png"
            )
    ...
    if await CustomFilters.authorized(_, message):
        ...
        await send_message(
            message, start_string, reply_markup, photo="assets/BHARTIYEE LEECH.png"
        )
    elif Config.BOT_PM:
        await send_message(
            message,
