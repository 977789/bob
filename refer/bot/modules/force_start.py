...
from ..helper.ext_utils.task_manager import (
    ...
    start_media_processing_from_queued,
)
...
"""
    ...
    async with queue_dict_lock:
        if status == "fu":
            ...
            elif listener.mid in queued_media_processing:
                listener.force_media_processing = True
                await start_media_processing_from_queued(listener.mid)
